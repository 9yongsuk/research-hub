  ...
  return (
    <div className="relative min-h-screen text-white px-6 py-16">
      ...
      <div className="max-w-7xl mx-auto">
        {/* 상단 타이틀 */}
        <div className="mb-16">
          <div className="text-sm tracking-widest text-cyan-400 mb-3">
            SERVICES
          </div>
          <h1 className="text-5xl font-semibold mb-6">연구 서비스</h1>
        ...
        <div className="mt-24">
          ...
          <h2 className="text-4xl font-semibold mb-12">협업 네트워크</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {collaborators.map((c) => (
              <div
                ...
                "
              >
                <h3 className="text-xl font-semibold mb-2">{c.role}</h3>

                <p className="text-white/60 text-sm mb-6">{c.who}</p>
                ...
                {c.notes && (
                  <div className="mt-6 text-white/60 text-sm">{c.notes}</div>
                )}
              </div>
            ))}
          </div>
